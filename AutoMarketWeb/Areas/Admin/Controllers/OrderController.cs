...
namespace AutoMarketWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                IEnumerable<OrderHeader> objOrderHeaderList = _unitOfWork.OrderHeader.GetAll(includeProperties: "ApplicationUser");
        ...
        public IActionResult Details_PAY_NOW()
        {
            ...
            OrderVM.OrderDetail = _unitOfWork.OrderDetail.GetAll(u => u.OrderId == OrderVM.OrderHeader.Id, includeProperties: "Car");
        ...
        public IActionResult PaymentConfirmation(int orderHeaderId)
        {
            ...
            if (orderHeader.PaymentStatus == SD.PaymentStatusDelayedPayment)
            {
                ...
                //sprawdzamy status płatności stripe
